...
public class LRUMemoryCacheConcurrenUnit_ParameterizedTest {
    private  String region;
	private static CompositeCacheManager cacheMgr;
    private static int items = 200;

	public LRUMemoryCacheConcurrenUnit_ParameterizedTest(String region) {
